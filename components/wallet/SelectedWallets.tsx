                    ...
                    <>
                        <WalletsContainer>
                            <SelectedWalletImg
                                ...
                                alt={selectedWallet.info?.name || "Wallet Icon"}
                            />
                            <p>
                                {selectedWallet.info?.name || "Unknown Wallet"}
                            </p>
                            <p>({selectedAccount})</p>
                            <p>
                                <strong>uuid:</strong>{" "}
                                {selectedWallet.info?.uuid || "N/A"}
                            </p>
                            <p>
                                <strong>rdns:</strong>{" "}
                                {selectedWallet.info?.rdns || "N/A"}
                            </p>
                        </WalletsContainer>
